...
fn main() {
    ...
    let mut crates: [Vec<char>; 9] = [
        "FLMW".chars().collect::<Vec<char>>(),
        "FMVZB".chars().collect::<Vec<char>>(),
        "QLSRVH".chars().collect::<Vec<char>>(),
        "JTMPQVSF".chars().collect::<Vec<char>>(),
        "WSL".chars().collect::<Vec<char>>(),
        "WJRMPVF".chars().collect::<Vec<char>>(),
        "FRNPCQJ".chars().collect::<Vec<char>>(),
        "BRWZSPHV".chars().collect::<Vec<char>>(),
        "WZHGCJMB".chars().collect::<Vec<char>>(),
    ];
